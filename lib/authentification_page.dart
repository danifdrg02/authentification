import 'package:authentification/Home_page.dart';
import 'package:authentification/authentification.dart';
import 'package:flutter/material.dart';
//import 'package:explore/screens/home_page.dart';
//import 'package:authentification/authentication.dart';
            ...
            child: Column(
              ...
              children: [
                            ...
                            onPressed: () async {
                              ...
                              if (_validateEmail(textControllerEmail.text) ==
                                ...
                                await signInWithEmailPassword(
                                  ...
                                  print('erreur authentification: $error');
                                  setState(() {
                                    loginStatus =
                                ...
                                setState(() {
                                  loginStatus =
                                      'entrez votre email & mot de pass';
                                  loginStringColor = Colors.red;
                                });
                              }
                              setState(() {
                            ...
                            onPressed: () async {
                              ...
                              if (_validateEmail(textControllerEmail.text) ==
                                ...
                                await registerWithEmailPassword(
                                  ...
                                  if (result != null) {
                                    setState(() {
                                      loginStatus = 'inscription reussi';
                                      loginStringColor = Colors.green;
                                    });
                                    print(result);
                                  }
                ...
                Padding(
                  ...
                  child: Text(
                    "En procédant, vous acceptez nos conditions d'utilisation et confirmez que vous avez lu notre politique de confidentialité.",
                    maxLines: 2,
                    style: TextStyle(
                      color: Theme.of(context).textTheme.subtitle2.color,
                      fontSize: 14,
